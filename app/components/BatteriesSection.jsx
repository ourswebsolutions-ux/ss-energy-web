                          ...
                          <div className="bg-white border border-gray-200 rounded-2xl p-3 flex flex-col justify-between h-full shadow-xs hover:shadow-md transition-shadow relative">
                            ...
                            <div>
                              ...
                              <div className="relative w-full h-44 bg-emerald-50/40 rounded-xl overflow-hidden mb-3 flex items-center justify-center">
                                ...
                                <Image
                                  src={product.image || "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=400&q=80"}
                                  alt={product.title || "Battery"}
                                  fill
                                  unoptimized
                              ...
                              {(product.specs || product.warranty) && (
                                <div className="mb-3 flex flex-wrap gap-1.5">
                                  ...
                                  {product.warranty && (
                                    <span className="inline-flex items-center gap-1 bg-emerald-50 border border-emerald-200 text-emerald-700 text-[11px] font-medium px-2 py-0.5 rounded-md">
                                      🛡️ {product.warranty}
                                    </span>
                                  )}
                                </div>
                            ...
                            <div>
                              ...
                              {/* Action Button – exact same color as Admin Live Preview for batteries */}
                              <button
                                onClick={() => sendToWhatsApp(product)}
                                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold py-2.5 px-3 rounded-xl flex items-center justify-center gap-1.5 transition-colors cursor-pointer shadow-xs"
                              >
                                <ShoppingBag size={14} />
